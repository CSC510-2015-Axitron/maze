$(function() {
    ...
    localDB = false, //change to false to access remoteDB
    inputLock = false, //input device lock
    mouseAction = {},
    soundOn = true, //turn the background music on/off
    ...
    theUserData = new userData(0),
    userData = function(initTime){
    ...
    //
    mouseWorkEngine = function(canvas) {
    ...
    getRandomLevelInCat = function (catId){
